...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/azert/Documents/lab_fpga_diallo/ascon_version_registre_enhanced_final/ascon_version_registre_enhanced_final.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
