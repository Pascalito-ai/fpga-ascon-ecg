...
#
# Script generated by Vivado on Mon Mar 16 16:13:36 +0100 2026
...
# script info
echo -e "clk_wiz.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz xil_defaultlib.clk_wiz xil_defaultlib.glbl -log elaborate.log
}
...
Usage: clk_wiz.sh [-rerun]\n\
Usage: clk_wiz.sh [-reset_run]\n\
Usage: clk_wiz.sh [-clean]\n\
