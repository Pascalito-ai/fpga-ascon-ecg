...
#
# Script generated by Vivado on Fri Mar 06 15:35:56 +0100 2026
...
#                c_shift_ram_0.sh [-rerun]
#                c_shift_ram_0.sh [-reset_run]
#                c_shift_ram_0.sh [-clean]
...
# script info
echo -e "c_shift_ram_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot c_shift_ram_0 xil_defaultlib.c_shift_ram_0 xil_defaultlib.glbl -log elaborate.log
}
...
Usage: c_shift_ram_0.sh [-rerun]\n\
Usage: c_shift_ram_0.sh [-reset_run]\n\
Usage: c_shift_ram_0.sh [-clean]\n\
