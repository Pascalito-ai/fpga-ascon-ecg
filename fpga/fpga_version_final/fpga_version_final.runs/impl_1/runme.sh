...
HD_PWD='C:/Users/azert/Documents/lab_fpga_diallo/fpga_version_final/fpga_version_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ascon_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ascon_top.tcl -notrace
